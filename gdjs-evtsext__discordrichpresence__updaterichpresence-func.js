...
gdjs.evtsExt__DiscordRichPresence__UpdateRichPresence.userFunc0x88df30 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
if (!gdjs.evtTools.discordRP.client || !gdjs.evtTools.discordRP.client.user) return;
...
gdjs.evtTools.discordRP.client.user.setActivity(payload).catch((e) => gdjs.Logger.getLoggerOutput().log("Discord Rich Presence", e));
...
gdjs.evtsExt__DiscordRichPresence__UpdateRichPresence.userFunc0x88df30(runtimeScene, eventsFunctionContext);
